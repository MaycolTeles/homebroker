...
def aware_datetime(*args) -> datetime:
    """
    ...
    -----------
        ...
        * `hour`: `int`
            The hour of the datetime object. Default is 0.

        * `minute`: `int`
            The minute of the datetime object. Default is 0.

        * `second`: `int`
            The second of the datetime object. Default is 0.

        * `microsecond`: `int`
            The microsecond of the datetime object. Default is 0.

    Returns:
    --------
        * `datetime`
            The datetime object created and made aware.
    """
    return datetime(*args, tzinfo=get_current_timezone())
